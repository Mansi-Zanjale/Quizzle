...
<section class="form-container">
   ...
   <form action="" method="POST">
      ...
      <input type="text" name="name" maxlength="20" placeholder="<?=htmlspecialchars($fetch_profile['name']);
 ?>" class="box" oninput="this.value = this.value.replace(/\s/g, '')"readonly>
      <input type="text" name="name" maxlength="20" placeholder="Enter your new username" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
